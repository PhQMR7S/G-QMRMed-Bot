...
class Settings(BaseSettings):
    ...
    huggingface_timeout_seconds: float = Field(
        ...
        gt=0,
        le=900,
        alias="HUGGINGFACE_TIMEOUT_SECONDS",
    )
    ...
    media_transcription_model: str = Field(
        ...
        alias="MEDIA_TRANSCRIPTION_MODEL",
    )
    ...
    admin_panel_url: str = Field(
        default="https://gqmrmed-bot-api.onrender.com",
        alias="ADMIN_PANEL_URL",
    )
